...
We introduce the Twin Neighbor Embedding (#tne) method and the #twin software package
aimed at mitigating the limitations of #{sne}-based methods. #tne is not a layout algorithm
in the traditional sense, but instead a pre-layout transform of $G$ which constructs a
